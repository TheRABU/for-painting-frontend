...
const ViewDetails = () => {
  ...
  return (
    <>
      ...
      <section className="dark:bg-gray-100 h-screen py-20 dark:text-gray-800">
            ...
            <div className="flex space-x-2 sm:space-x-4">
              ...
              <div className="space-y-2">
                ...
                <p className="leading-snug">
                  {craftDetails?.short_desc || <p>No Details found</p>}
                </p>
              </div>
            </div>
            <div className="flex space-x-2 sm:space-x-4">
              ...
              <div className="space-y-2">
                <p className="text-lg font-medium leading-snug">
                  Price: {craftDetails?.price || <p>No Details found</p>}
                </p>
                <p className="leading-snug">
                  Customization:{" "}
                  {craftDetails?.customization || <p>No Details found</p>}
                </p>
              </div>
            </div>
            <div className="flex space-x-2 sm:space-x-4">
              ...
              <div className="space-y-2">
                <p className="text-lg font-medium leading-snug">
                  Rating: {craftDetails?.rating || <p>No Details found</p>}
                </p>
                <p className="leading-snug">
                  Process Time:{" "}
                  {craftDetails?.process_time || <p>No Details found</p>}
                </p>
                <span className="indicator-item badge badge-primary">
                  {craftDetails?.stock_status || <p>No Details found</p>}
                </span>
              </div>
            </div>
          </div>
